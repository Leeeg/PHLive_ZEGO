...
import com.i5i58.live.common.view.progressBar.SaundProgressBar;
...
//    }
    ...
    public void update() {
        ...
        if (UpdateUtil.verify(mApkFile, mInfo.md5)) {
            LogUtil.d("app update onInstall !");
            onInstall();
        } else {
            LogUtil.d("app update onDownload !");
            onDownload();
        }
    }
...
//            final MainActivity baseActivity = (MainActivity) APPManager.getInstance().currentActivity();
//            View parent = ((ViewGroup) baseActivity.findViewById(android.R.id.content)).getChildAt(0);
//            popView = (RelativeLayout) View.inflate(mContext, R.layout.dialog_update, (ViewGroup) baseActivity.findViewById(R.id.root));
//            popView.setFocusable(true);
//            popView.setFocusableInTouchMode(true);
////            root = (RelativeLayout) popView.findViewById(R.id.root);
//
//            percent = (TextView) popView.findViewById(R.id.percent);
//            percent.setText("0%");
//            mPbar = (SaundProgressBar) popView.findViewById(R.id.regularprogressbar);
//            mPbar.setMax(99);
//            mPbar.setProgress(0);
...
//                    LogUtil.d("upDate popWindow onKeyClick");
//                    if (event.getAction() == KeyEvent.ACTION_DOWN && keyCode == KeyEvent.KEYCODE_BACK){
//                        LogUtil.d("upDate popWindow onKeyBackClick");
//                        return true;
//                    }
//                    return false;
//                }
...
//            }
    ...
    public static class NotificationProgress implements UpdateAgent.OnProgressListener {
        ...
        public void onStart() {
            if (mBuilder == null) {
                String title = "更新中 - " + mContext.getString(mContext.getApplicationInfo().labelRes);
