...
import static com.i5i58.live.luban.Preconditions.checkNotNull;
...
public class Luban {
    ...
    private File myCompress(@NonNull File file) {
        int minSize = 1024;
        int longSide = 720;
        int shortSide = 1280;
    ...
    private File saveImage(String filePath, Bitmap bitmap, long size) {
        LogUtil.d("saveImage size is : " + size);
