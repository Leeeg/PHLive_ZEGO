...
import com.i5i58.live.widget.animation.Effectstype;
import com.i5i58.live.widget.utils.DateUtils;
...
public class LocationSelectorDialogBuilder extends NiftyDialogBuilder implements
	...
	private void setDialogProperties() {
		int width = DateUtils.getScreenWidth(context) * 4 / 5;
...
//				.withTitleColor("#919191").withTitle("选择地区")
				...
				.withPreviousText("取消").withPreviousTextColor("#3598da")
				.withDuration(200).setPreviousLayoutClick(this)
				.withNextText("保存").withNextTextColor("#3598da")
