 ...
 */
package com.i5i58.live.common.view.xListView;
...
public class XListView extends ListView implements OnScrollListener {
	...
	public void doAutoLoadMore() {
		autoLoadMore = true;
		setOnScrollListener(new AutoLoadMoreListener());
	}
	 ...
	 */
	public void stopLoadMore(boolean hasmore) {
		if (mPullLoading == true) {
			...
			if (hasmore) {
				...
				if (mScrollListener instanceof AutoLoadMoreListener) {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		try {
			...
			LogUtil.e("XListView IndexOutOfBoundsException");
			return false;
		}
	}
	...
	public class AutoLoadMoreListener implements OnXScrollListener {
