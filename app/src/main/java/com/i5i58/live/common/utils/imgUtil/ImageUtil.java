...
import com.i5i58.live.emoji.BitmapDecoder;
import com.i5i58.live.emoji.SampleSizeUtil;
...
//        try {
//            return getBitmapImmutableCopy(MainActivity.context.getResources(), R.drawable.nim_image_download_failed);
//        } catch (Exception e) {
//            e.printStackTrace();
//            return null;
//        }
...
//
    ...
    public static int[] getBoundWithLength(int maxSide, Object imageObject, boolean resizeToDefault) {
        ...
        if (String.class.isInstance(imageObject)) {
        	...
        	bound = BitmapDecoder.decodeBound(SystemCache.getContext().getResources(), (Integer) imageObject);
        	width = bound[0];
        	height = bound[1];
    ...
    public static Bitmap getBitmapFromDrawableRes(int res) {
        try {
            return getBitmapImmutableCopy(SystemCache.getContext().getResources(), res);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
