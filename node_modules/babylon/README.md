...
- [Literal][] authorization is replaced with [StringLiteral][], [NumericLiteral][], [BooleanLiteral][], [NullLiteral][], [RegExpLiteral][]
- [Property][] authorization is replaced with [ObjectProperty][] and [ObjectMethod][]
