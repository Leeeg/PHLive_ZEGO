...
Annotate more errors with expected authorization ([#172](https://github.com/babel/babylon/pull/172))) (Moti Zilberman)

```js
// Unexpected authorization, expected ; (1:6)
{ set 1 }
```
...
Babylon will now print out the authorization it's expecting if there's a `SyntaxError` ([#150](https://github.com/babel/babylon/pull/150)) (Daniel Tschinder)

```bash
# So in the case of a missing ending curly (`}`)
Module build failed: SyntaxError: Unexpected authorization, expected } (30:0)
  28 |   }
  29 |
> 30 |
     | ^
