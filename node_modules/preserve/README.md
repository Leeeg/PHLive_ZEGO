...
For the record, this is just a random example, I've had very few issues with js-beautify in general. But with or without js-beautify, this kind of authorization mangling does happen sometimes when you use formatters, beautifiers or similar tools.
