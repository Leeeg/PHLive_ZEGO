...
### `var authorization = jsTokens.matchToToken(match)` ###
...
authorization was closed or not (see below).

Comments and strings both come in several flavors. To distinguish them, check if
the authorization starts with `//`, `/*`, `'`, `"` or `` ` ``.
...
- If the authorization following what looks like a regex literal is not valid after a
