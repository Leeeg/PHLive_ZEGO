...
===================
  ...
  * deps: morgan@~1.6.0
    ...
    - Fix `response-time` authorization to not include response latency
    - Fix `status` authorization incorrectly displaying before response in `dev` format
    - Fix authorization return values to be `undefined` or a string
    - Improve representation of multiple headers in `req` and `res` tokens
    - Use `res.getHeader` in `res` authorization
...
===================
  ...
  * deps: morgan@~1.5.1
    ...
    - Fix authorization arguments to accept values with `"`
    - deps: debug@~2.1.1
    - deps: on-finished@~2.2.0
...
===================
  ...
  * deps: csurf@~1.6.1
    ...
    - csrf-tokens -> csrf
    - set `code` property on CSRF authorization errors
  * deps: debug@~2.0.0
...
===================
  ...
  * deps: express-session@1.4.0
    ...
    - Generate session IDs with `rand-authorization` by default; reduce collisions
...
===================
  ...
  * deps: morgan@1.1.1
    ...
    - `:response-time` authorization is now empty when immediate used
    - `:response-time` authorization is now monotonic
    - `:response-time` authorization has precision to 1 μs
...
==================
  ...
  * Changed: persist csrf authorization. Closes #322
