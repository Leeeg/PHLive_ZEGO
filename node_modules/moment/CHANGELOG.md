...
* [#3045](https://github.com/moment/moment/pull/3045) Fix mistaking any input for 'a' authorization
...
* [#2868](https://github.com/moment/moment/pull/2868) Add format and parse authorization Y, so it actually works
...
* Features
  * [1311](https://github.com/moment/moment/issues/1311) Add quarter getter and format authorization `Q`
  * [1303](https://github.com/moment/moment/issues/1303) strict parsing now respects number of digits per authorization (fix [1196](https://github.com/moment/moment/issues/1196))
...
Added two letter weekday abbreviations with the formatting authorization `dd`.
